            ...
            yield return new FormatViewDefinition("System.Management.Automation.PSStyle",
                ListControl.Create()
                    .StartEntry()
                        ...
                        .AddItemScriptBlock(@"""$($_.Formatting.FormatAccent)Example Text$($PSStyle.Reset)""", label: "Formatting.FormatAccent")
                        ...
                        .AddItemScriptBlock(@"""$($_.Foreground.LightGray)Example Text$($PSStyle.Reset)""", label: "Foreground.LightGray")
                        .AddItemScriptBlock(@"""$($_.Foreground.Red)Example Text$($PSStyle.Reset)""", label: "Foreground.Red")
                        .AddItemScriptBlock(@"""$($_.Foreground.LightRed)Example Text$($PSStyle.Reset)""", label: "Foreground.LightRed")
                        .AddItemScriptBlock(@"""$($_.Foreground.Magenta)Example Text$($PSStyle.Reset)""", label: "Foreground.Magenta")
                        .AddItemScriptBlock(@"""$($_.Foreground.LightMagenta)Example Text$($PSStyle.Reset)""", label: "Foreground.LightMagenta")
                        .AddItemScriptBlock(@"""$($_.Foreground.Blue)Example Text$($PSStyle.Reset)""", label: "Foreground.Blue")
                        .AddItemScriptBlock(@"""$($_.Foreground.LightBlue)Example Text$($PSStyle.Reset)""", label: "Foreground.LightBlue")
                        .AddItemScriptBlock(@"""$($_.Foreground.Cyan)Example Text$($PSStyle.Reset)""", label: "Foreground.Cyan")
                        .AddItemScriptBlock(@"""$($_.Foreground.LightCyan)Example Text$($PSStyle.Reset)""", label: "Foreground.LightCyan")
                        .AddItemScriptBlock(@"""$($_.Foreground.Green)Example Text$($PSStyle.Reset)""", label: "Foreground.Green")
                        .AddItemScriptBlock(@"""$($_.Foreground.LightGreen)Example Text$($PSStyle.Reset)""", label: "Foreground.LightGreen")
                        .AddItemScriptBlock(@"""$($_.Foreground.Yellow)Example Text$($PSStyle.Reset)""", label: "Foreground.Yellow")
                        .AddItemScriptBlock(@"""$($_.Foreground.LightYellow)Example Text$($PSStyle.Reset)""", label: "Foreground.LightYellow")
                        .AddItemScriptBlock(@"""$($_.Background.Black)Example Text$($PSStyle.Reset)""", label: "Background.Black")
                        .AddItemScriptBlock(@"""$($_.Background.White)Example Text$($PSStyle.Reset)""", label: "Background.White")
                        .AddItemScriptBlock(@"""$($_.Background.DarkGray)Example Text$($PSStyle.Reset)""", label: "Background.DarkGray")
                        .AddItemScriptBlock(@"""$($_.Background.LightGray)Example Text$($PSStyle.Reset)""", label: "Background.LightGray")
                        .AddItemScriptBlock(@"""$($_.Background.Red)Example Text$($PSStyle.Reset)""", label: "Background.Red")
                        .AddItemScriptBlock(@"""$($_.Background.LightRed)Example Text$($PSStyle.Reset)""", label: "Background.LightRed")
                        .AddItemScriptBlock(@"""$($_.Background.Magenta)Example Text$($PSStyle.Reset)""", label: "Background.Magenta")
                        .AddItemScriptBlock(@"""$($_.Background.LightMagenta)Example Text$($PSStyle.Reset)""", label: "Background.LightMagenta")
                        .AddItemScriptBlock(@"""$($_.Background.Blue)Example Text$($PSStyle.Reset)""", label: "Background.Blue")
                        .AddItemScriptBlock(@"""$($_.Background.LightBlue)Example Text$($PSStyle.Reset)""", label: "Background.LightBlue")
                        .AddItemScriptBlock(@"""$($_.Background.Cyan)Example Text$($PSStyle.Reset)""", label: "Background.Cyan")
                        .AddItemScriptBlock(@"""$($_.Background.LightCyan)Example Text$($PSStyle.Reset)""", label: "Background.LightCyan")
                        .AddItemScriptBlock(@"""$($_.Background.Green)Example Text$($PSStyle.Reset)""", label: "Background.Green")
                        .AddItemScriptBlock(@"""$($_.Background.LightGreen)Example Text$($PSStyle.Reset)""", label: "Background.LightGreen")
                        .AddItemScriptBlock(@"""$($_.Background.Yellow)Example Text$($PSStyle.Reset)""", label: "Background.Yellow")
                        .AddItemScriptBlock(@"""$($_.Background.LightYellow)Example Text$($PSStyle.Reset)""", label: "Background.LightYellow")
                        .EndEntry()
                .EndList());
        }
